...
######################################
    ...
    with tab4:
        ...
        - Exclure le dataset 2 (Leukemia Dataset).<br>
...
## %%% PAGE MACHINE LEARNING %%% ##
    ...
    with tab5:
        ...
        **La variable cible est la 'Classe' des cellules.
        Les 'features' retenues pour les modèles sont toutes les autres variables à l'exception de 'Nom', 'Numéro', 'Boîte encadrante' et 'Centre'.**
        """)
...
## %%% PAGE DEEP LEARNING %%% ##
    ...
    with tab7:
        ...
        st.markdown("""
        - Nous importons les bibliothèques comme TensorFlow et les modules nécessaires pour construire le modèle et effectuer l'apprentissage. 
    ...
    with tab8:
        st.markdown("""
        Le transfer learning permet d'utiliser des modèles pré-entraînés pour obtenir de meilleures performances.
